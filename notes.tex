...
\[
\begin{aligned}
\int_{\partial \mathbb B_r(z_1)} f &= \sum_{k=1}^{-m} c_k \underbrace{\int_{\partial \mathbb B_r(z_1)} (z-z_1)^k \ \mathrm d z}_{2\pi i\delta_{k,-1}\text{ by Remark before Theorem \ref{thm:cauchyintform}}} + \underbrace{\int_{\partial \mathbb B_r(z_1)} \phi_1 \ \mathrm d z}_{0\text{ by Cauchy}} \\
